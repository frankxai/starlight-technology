...
export function SiteFooter() {
  return (
    <footer className="site-footer">
      ...
      <div className="footer-links"><Link href="/about">About</Link><Link href="/xr">XR devices</Link><Link href="/methodology">Methodology</Link><Link href="/disclosure">Disclosure</Link><Link href="/privacy">Privacy</Link><a href="https://www.frankx.ai/stack">FrankX Stack ↗</a></div>
